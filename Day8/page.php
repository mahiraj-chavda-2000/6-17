                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_array()) {
                            ...
                            <div class="MyDiv" id="<?php echo $row['id']; ?>">
                                ...
                                <button onclick="return deleteBtn(this.id,this,<?php echo $row['id']; ?>)" name="delete" id="<?php echo $row['id']; ?>" >-<input type="hidden" name="hidden1[]" id="hiddenid1" value="0"></button>
